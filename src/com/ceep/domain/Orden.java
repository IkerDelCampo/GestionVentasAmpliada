...
public class Orden {
    ...
    public void agregarComputadora(Computador computadora){
        ...
        }else{System.out.println("Alcanzado el número maximo de computadoras: PC ["+(contadorComputadoras+1)+"] NO AÑADIDO");}
    }
    //MOSTAR
    public void mostarOrden(){
        for(int i=0; i <contadorComputadoras; i++){
            ...
            System.out.println("El Nombre del PC ["+(i+1)+"] es ->"+computadoras[i].getMonitor());
            System.out.println("El Nombre del PC ["+(i+1)+"] es ->"+computadoras[i].getRaton());
            System.out.println("El Nombre del PC ["+(i+1)+"] es ->"+computadoras[i].getTeclado());
        }
